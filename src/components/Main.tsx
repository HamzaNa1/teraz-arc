  ...
  return (
    <div className="container flex flex-col max-w-full h-screen min-h-[900px] bg-[#323232]">
      ...
      <div className="relative w-full h-full">
        ...
        <div className="absolute hidden md:flex w-full h-full top-[180px] left-[40px] ">
          <img
            src="/images/blackstar.svg"
            className="w-16 h-16 rotate-45"
          ></img>
        </div>
        <div className="absolute hidden md:flex w-full h-full top-[140px] left-[120px]">
          <img src="/images/blackstar.svg" className="w-16 h-16"></img>
        </div>
        <div className="absolute hidden md:flex w-full h-full top-[340px] left-[40px]">
          <img
            src="/images/blackstar.svg"
            className="w-16 h-16 rotate-45"
          ></img>
        ...
        <div className="absolute hidden md:flex w-full h-full top-[280px] left-[100px]">
          <img src="/images/blackstar.svg" className="w-16 h-16"></img>
        </div>
